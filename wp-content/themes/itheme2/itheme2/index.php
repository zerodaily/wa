	...
	<div id="content" class="clearfix">
		...
		<?php if(is_author()) : ?>
			...
			<div class="author-bio clearfix">
				...
				<h2 class="author-name"><?php _e('关于','themify'); ?> <?php echo $curauth->first_name; ?> <?php echo $curauth->last_name; ?></h2>
			...
			<h2 class="author-posts-by"><?php _e('文章由','themify'); ?> <?php echo $curauth->first_name; ?> <?php echo $curauth->last_name; ?>:</h2>
		<?php endif; ?>
		...
		?>
		<?php if(is_search()): ?>
			<h1 class="page-title"><?php _e('搜索结果：','themify'); ?> <em><?php echo get_search_query(); ?></em></h1>
		<?php endif; ?>
