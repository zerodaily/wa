...
<div id="post-<?php the_ID(); ?>" <?php post_class('post clearfix'); ?>>
	...
	<div class="post-content">
		...
		<?php if($hide_meta != 'yes'): ?>
			<p class="post-meta"> 
				<span class="post-author"><?php _e( '作者：', 'themify' ); ?> <?php the_author() ?>  &bull;</span>
				<span class="post-category"><?php the_category(', ') ?>  &bull;</span>
				<?php if(comments_open()) : ?>
					<span class="post-comment"><?php comments_popup_link('0', '1', '%'); ?></span>
				<?php endif; //post comment ?>
				<?php the_tags(__(' <span class="post-tag">&bull; 标签: ','themify'), ', ', '</span>'); ?>
			</p>
		<?php endif; ?>    

		<?php edit_post_link(__('编辑', 'themify'), '[', ']'); ?>
