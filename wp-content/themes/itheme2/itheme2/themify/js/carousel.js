...
if (crsl.upDateOnWindowResize) {
	$(window).bind(cf_e('resize', conf, false, true, true), function(e) {
		...
		var crsl = {
			...
			$carwrap = $wrp.wrap('<div class="carousel-wrap" style="position: relative;" />').parent();
			
			if(undefined != options.prev || undefined != options.pagination){
				$slidernav = $carwrap.append('<div class="carousel-nav-wrap" />');
				if( undefined != options.prev )
					$('.carousel-nav-wrap', $slidernav).append('<a href="#" class="carousel-prev">&laquo;</a>');
				
				if( undefined != options.pagination )
					$('.carousel-nav-wrap', $slidernav).append('<div class="carousel-pager"></div>');
				
				if( undefined != options.prev )
					$('.carousel-nav-wrap', $slidernav).append('<a href="#" class="carousel-next">&raquo;</a>');
			}
