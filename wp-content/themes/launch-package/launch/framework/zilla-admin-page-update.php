		...
		if( $xml = zilla_get_theme_changelog() ) {
			...
			if( version_compare( $theme_version, $xml->latest ) == -1 ){
				...
				<div id="message" class="updated below-h2">
					<p><?php _e( '<strong>There is a new version of the '. $theme_name .' theme available.</strong> You have version '. $theme_version .' installed. Update to version '. $xml->latest .'.', 'zilla' ); ?></p>
				</div>
