...
if ( ! function_exists( 'wpex_gallery_metabox_css' ) ) {
	function wpex_gallery_metabox_css() { ?>
		<style>
			...
			.gallery_images .wc-metabox-sortable-placeholder{width: 80px;height: 80px;box-sizing: border-box;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;border:4px dashed #ddd;background:#f7f7f7 url(<?php echo get_template_directory_uri(); ?>/functions/gallery-metabox/image_watermark.png) no-repeat center}		
			.gallery_images .wpex-gmb-remove {background: #eee url(<?php echo get_template_directory_uri(); ?>/functions/gallery-metabox/delete.png) center center no-repeat;position: absolute;top: 2px;right: 2px;border-radius: 2px;padding: 2px;display: none;width: 10px;height: 10px;margin: 0;display: none;overflow: hidden;}	
...
function wpex_save_gallery_metabox( $post_id ) {
    if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE )
        return;
    $post_types = array( 'gallery', 'events' );
