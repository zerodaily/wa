...
add_action('admin_menu', 'wpex_wpex_page_meta');

function wpex_wpex_page_meta() {
	global $wpex_page_meta;
	
	add_meta_box($wpex_page_meta['id'], $wpex_page_meta['title'], 'wpex_show_page_meta', $wpex_page_meta['page'], $wpex_page_meta['context'], $wpex_page_meta['priority']);
...
function wpex_show_page_meta() {
	global $wpex_page_meta, $post;
	...
	foreach ($wpex_page_meta['fields'] as $field) {
...
add_action('save_post', 'wpex_save_page_meta_data');

/*-----------------------------------------------------------------------------------*/
//	Save data when post is edited
/*-----------------------------------------------------------------------------------*/
 
function wpex_save_page_meta_data($post_id) {
	global $wpex_page_meta;
