	...
	<li id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
            ...
            <div class="comment-details clr">
                ...
                <div class="reply">
                	<?php
					$wpex_reply_arrow = is_rtl() ? '&larr;' : '&rarr;'; ?>
                    <?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'reply to comment', 'wpex' ) .' '. $wpex_reply_arrow, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
                </div><!-- .reply -->
